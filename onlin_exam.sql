...
FROM 
    ...
    SELECT -- Retrieve all questions and corresponding options for a particular question paper --k
...
WHERE ur.exam_id = 1; -- Replace with the exam_id you want to verify --y



SELECT -- student who scored highest in each sem --y
    ex.exam_id, 
    qp.question_paper_title, 
    e.student_user_id, 
